...
export const formulaRegistry: Formula[] = [
  ...
  },
  {
    ...
    assumptions: ["Потери по трассе не выделяются отдельно в формуле прибора", "Свойства теплоносителя принимаются постоянными"],
  ...
  },
  {
    ...
    assumptions: ["Теплоемкость теплоносителя принимается постоянной", "Перепад температур задан расчетом"],
...
export const assumptions: Assumption[] = [
  {
    ...
    source: "ASHRAE Fundamentals, около 20 °C",
  },
  {
    id: "air_cp",
  ...
  },
  {
    ...
    source: "Типовые табличные значения для строительной теплотехники",
  },
  {
