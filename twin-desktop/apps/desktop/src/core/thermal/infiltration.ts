...
const DEFAULT_REFERENCE_PRESSURE_PA = 10;
const DEFAULT_PRESSURE_EXPONENT = 0.67;
const DEFAULT_ENVELOPE_LEAKAGE_M3S_M2_AT_10_PA = 0.00005;
const DEFAULT_WINDOW_LEAKAGE_M3S_M_AT_10_PA = 0.0008;
const DEFAULT_DOOR_LEAKAGE_M3S_M_AT_10_PA = 0.0012;
const DEFAULT_WIND_SPEED_M_S = 4;
const DEFAULT_WIND_PRESSURE_COEFFICIENT = 0.6;
