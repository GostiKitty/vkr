 ...
 */
export function interpolateSeasonalWindSpeedMps(
  winterWindSpeedM_s: number | null | undefined,
  summerWindSpeedM_s: number | null | undefined,
  dayOfYear: number
): number | null {
...
export function clampDayOfYear(dayOfYear: number | null | undefined): number {
