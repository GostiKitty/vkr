 ...
 */
export function snapAxesToNearbyAnchors(
  point: Vec2,
  anchors: readonly Vec2[],
  axisTolerance: number,
  vertexTolerance = 0.25
): Vec2 {
...
export function snapToPolygonBoundary(point: Vec2, polygons: readonly Vec2[][], tolerance: number): Vec2 | null {
  let bestDistance = tolerance;
