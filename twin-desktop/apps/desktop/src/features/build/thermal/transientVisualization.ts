import { getTransientFrame, type TransientCalculationResult, type TransientVisualizationFrame } from "../../../core/thermal/transient/index";

export function clampTransientTimeIndex(result: TransientCalculationResult | null, timeIndex: number): number {
...
}): TransientVisualizationFrame | null {
...
export function transientSourceMatches(
  frame: TransientVisualizationFrame | null,
