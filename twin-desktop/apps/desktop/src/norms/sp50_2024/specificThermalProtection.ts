export interface KobNormCell {
  heatedVolumeM3: number;
  valuesByGsop: Record<number, number>;
}

export const KOB_GSOP_POINTS = [1000, 3000, 5000, 8000, 12000] as const;

export const KOB_NORM_TABLE: KobNormCell[] = [
...
export function interpolateKobNormFromTable(heatedVolumeM3: number, gsop: number): number | null {
...
export function calculateKobNormByFormula(heatedVolumeM3: number, gsop: number): number | null {
...
export function calculateKobNormFloor(gsop: number): number {
  return 8.5 / gsop;
}

function interpolateByGsop(valuesByGsop: Record<number, number>, gsop: number): number | null {
