 ...
 */
const BETA_V_BY_CATEGORY: Partial<Record<Sp50BuildingCategory, number>> = {
  residential: 0.85,
  medical: 0.9,
  preschool: 0.9,
  educational: 0.9,
...
export function getVolumeCoefficientBetaV(category: Sp50BuildingCategory | undefined): number {
  if (!category) {
    return 0.85;
  }
