...
export interface Sp131CityClimate {
  ...
  gsop?: number;
  /** Средняя скорость ветра в январе (СП 131.13330, табл. Б.2), м/с. Используется в проверке воздухопроницаемости СП 50. */
  winterWindSpeedM_s?: number;
  /** Средняя скорость ветра в июле (СП 131.13330, табл. Б.2), м/с. Используется в расчёте летней теплоустойчивости СП 50. */
