import { calculateGsop, getExternalHeatTransferCoefficient, getInternalHeatTransferCoefficient, getMaterialThermalProperties, getRequiredResistance, getRequiredResistanceTableCategory, getSpecificThermalProtectionNorm, } from "../../src/norms/sp50_2024/index.js";
import { calculateAirSpecificWeight, calculateAnnualHeatingEnergy, calculateConstructionResistance, calculateFloorHeatAbsorption, calculateHeatTransferCoefficient, calculateHeatingEnergyCharacteristic, calculateKob, calculateLayerResistance, calculatePressureDifference, calculateRequiredAirPermeabilityResistance, calculateSectionTemperature, calculateThermalInertia, calculateVaporResistance, checkKobCompliance, checkResistanceCompliance, } from "../../src/core/thermal/sp50/calculations.js";
...
function createSp50EnvelopeModel() {
    return {
