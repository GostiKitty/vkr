import { resolvePipeCircuitRole } from "../../../entities/networks/types";
import { buildHeatingModelSnapshot } from "../../../core/networks/index";
import { getEquipmentDisplayName } from "../utils/entityLabels";
export function buildNetworkConnectivityWarnings(model) {
    const warnings = [];
...
export function pipeHasDistinctRole(pipe, role) {
