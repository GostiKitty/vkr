import { buildDataRequirementsAudit, calculateCO2, calculateCompactness, calculateDegreeHoursOverheat, calculateDegreeHoursUnderheat, calculateEquivalentUValue, calculateOperativeTemperature, calculatePipeHeatLoss, calculateSurfaceTemperatureFactor, calculateTotalHeatLossCoefficient, calculateValidationMetrics, calculateWindowToWallRatio, } from "../../src/core/thermal/derived/buildingPerformanceMetrics.js";
...
function buildAuditFixture(overrides = {}) {
