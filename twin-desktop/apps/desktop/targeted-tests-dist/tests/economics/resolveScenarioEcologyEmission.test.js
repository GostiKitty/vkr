...
import { defaultCo2EmissionFactorFromEcologyEnergySource, ecologyEnergySourceToHeatingSource, } from "../../src/core/economics/defaultCo2EmissionFactors.js";
import { resolveScenarioEcologyEmissionFactor, syncEcologyEmissionFactorOnEnergySourceChange, } from "../../src/core/economics/resolveScenarioEcologyEmission.js";
...
test("syncEcologyEmissionFactorOnEnergySourceChange updates norm-linked values only", () => {
    const ecology = { energySource: "electricity", emissionFactorKgPerKWh: 0.35 };
