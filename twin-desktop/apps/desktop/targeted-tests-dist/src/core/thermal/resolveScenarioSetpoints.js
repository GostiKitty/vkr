...
export function resolveNightSetpointScalar(_scenarioConfig, resolved, model) {
...
export function applyModelIndoorSetpointsToConfig(draft, model) {
...
export function setpointScalarToOrigin(source) {
    return source;
}
