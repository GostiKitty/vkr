...
export function resolveRelativeHumidityPercent(scenarioConfig, scenario, model) {
...
export function resolveComfortMinC(scenarioConfig, scenario) {
...
export function resolveComfortMaxC(scenarioConfig, scenario) {
...
export function estimateMrtFromEnvelope(model, indoorTemperatureC, outdoorDesignC) {
    ...
    fragments.forEach((fragment) => {
        ...
        const tau_si = internalSurfaceTemperatureC(indoorTemperatureC, outdoorDesignC, props.rSi_m2K_W || 0.13, totalResistance);
...
export function estimateBuildingMeanMrtC(thermalResult) {
...
export function buildPerformanceOptionsFromScenario(scenarioConfig, scenario, model) {
