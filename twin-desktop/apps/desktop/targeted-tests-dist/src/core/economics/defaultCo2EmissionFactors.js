...
export const DEFAULT_CO2_EMISSION_FACTORS_KG_PER_KWH = {
    gas: 0.22,
    heat: 0.2,
    electricity: 0.35,
    unknown: 0.22,
};
export const CO2_EMISSION_FACTOR_NORM_NOTES = {
...
export function defaultCo2EmissionFactorKgPerKWh(heatingSource) {
...
export function ecologyEnergySourceToHeatingSource(energySource) {
    ...
    if (normalized === "централизованное теплоснабжение" ||
...
export function defaultCo2EmissionFactorFromEcologyEnergySource(energySource) {
