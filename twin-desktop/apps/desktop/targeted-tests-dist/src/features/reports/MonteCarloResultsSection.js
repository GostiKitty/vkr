...
export function MonteCarloResultsSection({ baseResult, baseOptions, buildingModel, climateLabel, monteCarloResult, onRunCalculation, }) {
    ...
    const runControls = (_jsxs(_Fragment, { children: [!monteCarloResult ? (_jsx(WorkspaceInlineNotice, { message: !baseResult
                    ...
                    : `Для первой оценки риска обычно достаточно 50-100 прогонов; ${DEFAULT_MONTE_CARLO_RUNS} дают стабильнее P10/P90.`, actions: !baseResult
                    ? onRunCalculation ? (_jsx("button", { type: "button", onClick: onRunCalculation, className: "ui-btn-primary px-4 py-2 text-sm", children: "\u0417\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u044C \u0440\u0430\u0441\u0447\u0451\u0442" })) : null
                    : (_jsx("button", { type: "button", onClick: () => runThermalMonteCarloAnalysis(), className: "ui-btn-primary px-4 py-2 text-sm", children: "\u0417\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u044C Monte Carlo" })) })) : null, _jsx(MonteCarloRunControls, {})] }));
    if (!monteCarloResult) {
        return (_jsxs("div", { className: "space-y-5", "data-testid": "monte-carlo-results-section", children: [runControls, _jsx(ThermalTimeSeriesChartBlock, { heatingDisplay: "raw", onRunCalculation: onRunCalculation })] }));
    }
