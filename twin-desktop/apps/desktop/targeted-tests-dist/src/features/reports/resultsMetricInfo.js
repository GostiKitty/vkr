export const resultsMetricInfo = {
    ...
    buildingLossBreakdown: {
        ...
        meaning: "Разложение мощности теплопотерь здания по каналам в пиковом срезе RC-модели: ограждения, окна, двери, инфильтрация и вентиляция.",
    ...
    buildingTotalHeatLossKW: {
        ...
        meaning: "Мощность теплопотерь здания в опорном срезе RC-расчёта: сумма трансмиссионных и воздухообменных составляющих.",
    ...
    requiredHeatingPowerKW: {
        ...
        meaning: "Статический баланс в опорном срезе RC: суммарные теплопотери здания за вычетом внутренних теплопоступлений.",
