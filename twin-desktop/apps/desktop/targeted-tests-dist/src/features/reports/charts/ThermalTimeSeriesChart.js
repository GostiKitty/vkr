...
function ThermalTimeSeriesTooltipContent({ active, payload, label, mode, heatingIsEquipment, hasUncertaintyBand, }) {
    ...
    if (mode === "heating" && hasUncertaintyBand && point) {
        ...
        const p90 = p10 != null && point.heatingBandWidth != null ? p10 + point.heatingBandWidth : null;
    ...
    return _jsx(ThermalChartTooltip, { active: active, payload: payload, title: title, rows: rows });
}
