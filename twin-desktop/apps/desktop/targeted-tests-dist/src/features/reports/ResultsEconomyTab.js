...
export function ResultsEconomyTab({ report }) {
    if (!report) {
        return null;
    }
...
function EconomyAssessmentPanel({ report }) {
    ...
    const [co2Factor, setCo2Factor] = useState(baseScenario.co2EmissionFactor_kgPerKWh ?? DEFAULT_CO2_EMISSION_FACTORS_KG_PER_KWH.heat);
    ...
    useEffect(() => {
        ...
        setCo2Factor(baseScenario.co2EmissionFactor_kgPerKWh ??
