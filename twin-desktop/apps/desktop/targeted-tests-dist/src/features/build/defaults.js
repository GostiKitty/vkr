export const WALL_DEFAULTS = { thickness: 0.3, height: 3 };
...
export const STAIR_DEFAULTS = { stepCount: 12, totalRise_m: 3.0 };
export const DOOR_DEFAULTS = { width: 0.9, height: 2.1, swingDirection: "left", openingDirection: "inward" };
export const WINDOW_DEFAULTS = { width: 1.2, height: 1.4, sill: 0.9 };
export const PIPE_PRESET_DEFAULTS = {
    heating_supply: {
        type: "heating_supply",
...
export function createPipeDefaults(type) {
...
export function defaultEquipmentParams(type) {
    switch (type) {
        case "pump":
