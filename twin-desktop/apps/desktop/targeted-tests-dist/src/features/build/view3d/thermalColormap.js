 ...
 */
export function thermalColorFromValue(value, min, max) {
 ...
 */
export function percentileRange(values, minVisualRange = 2.0) {
    if (values.length === 0) {
...
export function thermalGradientCss() {
 ...
 */
export function binaryGradientCss(coldHex, hotHex) {
