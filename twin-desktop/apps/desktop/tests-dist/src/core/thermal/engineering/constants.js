...
export const DEFAULT_SURFACE_RESISTANCE_PROFILE = {
...
export const DEFAULT_SCENARIO_DRAFT = {
...
export const DEFAULT_ENGINEERING_OPTIONS = {
    mode: "engineering",
...
export const ENGINEERING_METHODS = [
    {
        id: "layer_resistance",
