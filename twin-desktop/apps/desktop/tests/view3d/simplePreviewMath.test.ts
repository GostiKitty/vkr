...
import {
  buildSimplePreviewBounds,
  calculateSimplePreviewCamera,
  calculateSimplePreviewGrid,
  resolveSimplePreviewLevelId,
} from "../../src/features/build/view3d/simplePreviewMath.js";
