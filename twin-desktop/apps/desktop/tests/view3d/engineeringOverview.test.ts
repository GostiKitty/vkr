...
import {
  ...
  buildEngineeringOverviewSummary,
  clearEngineeringOverviewPreset,
  ENGINEERING_OVERVIEW_PRESENTATION_MODE,
  isEngineeringOverviewPresetActive,
  shouldEnableEngineeringOverviewForDemoStep,
} from "../../src/features/build/view3d/engineeringOverview.js";
import type { BuildViewerOptions } from "../../src/features/build/view3d/viewerOptions.js";
import { test } from "../testHarness.js";

const baseViewer: BuildViewerOptions = {
  showRooms: false,
  showWalls: true,
  showOpenings: false,
  showNetworks: false,
