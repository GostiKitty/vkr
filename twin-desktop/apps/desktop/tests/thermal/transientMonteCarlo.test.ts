...
const VARIED_PARAMETERS: TransientUncertaintyParameter[] = [
  {
    id: "outdoor-offset",
    name: "Outdoor offset",
...
test("seed makes transient Monte Carlo reproducible", () => {
  ...
  if (
    JSON.stringify(left.samples.map((entry) => entry.parameters)) !==
