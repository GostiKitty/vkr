...
} from "../../src/features/build/engineering2d/render.js";
...
test("engineering 2d: air flow regulators keep exhaust medium and limit branch by smaller section and airflow", () => {
  ...
  if ((branch.metadata?.sectionTransitionRatio as number | undefined) == null || Number(branch.metadata.sectionTransitionRatio) < 1.7) {
